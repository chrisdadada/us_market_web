...
def main() -> None:
    ...
    parser.add_argument("--scanner-output", type=Path, default=Path("data/strength-scanner.json"))
    parser.add_argument("--review-output", type=Path, default=Path("data/strength-review.json"))
    parser.add_argument("--snapshot-dir", type=Path, default=Path("data/strength-snapshots"))
    parser.add_argument("--status-output", type=Path, default=Path("data/strength-refresh.json"))
    ...
    status = {
        ...
        "asOf": scanner["asOf"],
        "ok": True,
        "scannerOutput": str(args.scanner_output),
        "reviewOutput": str(args.review_output),
