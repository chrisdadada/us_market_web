        ...
        <div className="modalOverlay">
          <form className="adminModal courseModal" onSubmit={submitSeries}>
            ...
            <div className="editForm courseModalBody">
              ...
              <label>原价(U)<input value={seriesForm.originalPrice} onChange={(event) => setSeriesForm({ ...seriesForm, originalPrice: event.target.value })} placeholder="99" /></label>
              <label>折扣价(U)<input value={seriesForm.discountPrice} onChange={(event) => setSeriesForm({ ...seriesForm, discountPrice: event.target.value })} placeholder="9.9" /></label>
